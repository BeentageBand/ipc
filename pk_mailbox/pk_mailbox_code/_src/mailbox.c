...
static bool_t Mail_is_dumpable(Mail_T * const mail);
/*=====================================================================================* 
...
void Mailbox_init(void)
{
   ...
   Mailbox_Obj.mailbox = Vector_Mail();
...
bool_t Mail_is_dumpable(Mail_T * const mail)
{
   return mail->is_dumpable;
}
/*=====================================================================================* 
...
Mail_T * const mail Mailbox_get_mail_by_mail_id(Mailbox_T * const this, IPC_Mail_Id_T const mid)
{
   // find mail by id
